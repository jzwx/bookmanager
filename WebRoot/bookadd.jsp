...
<html>
  ...
  <body>
    ...
    <s:form action="book!add" method="post" enctype="multipart/form-data">
    	...
    	<s:select list="#request.lstbookcategory" listValue="name" listKey="id" label="图书分类" name="book.bookcategory.id"></s:select>
    	...
    	<s:submit value="确认添加" onclick="return funvalidate()"></s:submit>
    </s:form>
    <img alt="显示图书图片信息" src="" id="images"/>
  </body>
</html>
